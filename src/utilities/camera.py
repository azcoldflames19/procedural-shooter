# utilities/camera.py — smooth camera with gap and shake effects
# Calculates scroll offset based on player position & mouse aiming
# Also supports screen-shake and camera transitions
import random, math
import pygame
