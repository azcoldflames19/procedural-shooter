# utilities/text.py — queued on-screen text manager
# Stores timed text messages (e.g., wave notifications) and draws them
# Provides big/small fonts and input prompt handling
import pygame
