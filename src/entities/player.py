# entities/player.py — controllable player entity
# Manages input, movement, scaling animations, health & drawing
# Receives input via Game.event_controls and drives gameplay
import pygame
