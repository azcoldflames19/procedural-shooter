# entities/entity.py — base class for Player & Enemy
# Provides movement, scaling, collision helpers, health & drawing with shadow
# Shared foundation for all in-world entities
import pygame    
